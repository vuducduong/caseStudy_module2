...
<div class="main-body-content w-100 ets-pt">
    ...
    <tr>
        ...
        <td><a type="button" href="http://localhost/case_studymodule2/routeAdmin.php?admin=user&user=delete-user&id=<?php echo $user['id']?>" class="btn btn-danger" data-toggle="modal" data-target="#exampleModalCenter">Delete</a></td>
